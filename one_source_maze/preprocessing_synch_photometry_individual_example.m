...
cd C:\Users\Anna\Dropbox\Agrp\code\one_source_maze\example_data % example data dir

% Example data:
tracking = readtable('example_top_cam.csv'); % file name for the top view camera
Analog_table = readtable('example_AI.csv'); % file name for analog input from Doric system for synchronization
DLC = readtable('example_DLC_top_cam.csv'); % file name for deeplabcut tracking
food_cam = readtable('example_food_cam.csv'); % file name for food camera
...
interaction_food_csv = readtable('example_food_interaction.csv');
interaction_food_frames = table2array(interaction_food_csv);

eating_csv = readtable('example_eating.csv');
...
% Grooming
grooming_csv = readtable('example_Grooming.csv');
